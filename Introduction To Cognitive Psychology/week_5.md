...
**Answer: C — It primarily uses acoustic coding**
...
**Techniques designed to improve memory, often involving the use of visual imagery, are called:**
...
_Reference: Cognitive Psychology: In and Out of the Laboratory — Kathleen M. Galotti, Part II: Basic Cognitive Processes — Memory Structures: Long-Term Memory_
